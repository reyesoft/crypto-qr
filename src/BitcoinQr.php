...
use Reyesoft\CryptoQr\Exception\InvalidPathException;
use Reyesoft\CryptoQr\Exception\UnsupportedExtensionException;
use Reyesoft\CryptoQr\Writer\WriterInterface;

class BitcoinQr implements QrCodeInterface
{
